...
Installation guide for macOS. For Ubuntu/Debian-based Linux, see [README-linux.md](README-linux.md).
...
macOS picks up new fonts automatically — no cache refresh command is needed.

## Post-Installation

After completing the installation:
1. Open a new terminal (or restart your terminal app) to apply shell changes
...
**Verify**: Check that plugins are installed — `ls ~/Library/Caches/antidote/` should show plugin directories.
